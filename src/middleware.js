...
const{pathname}=request.nextUrl
  let res = await fetch(`https://movie-tickets-web-nextjs.vercel.app/api/admin/${sessionEmail}`);
  ...
  let response = await fetch(`https://movie-tickets-web-nextjs.vercel.app/api/user/${sessionEmail}`);
